...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.9]{schema/Angle_externe_1.PNG}
\end{figure}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.6]{schema/Angle_externe_2.png}
    \end{figure}
	\begin{flushright}
    $\bigstar $
    \end{flushright}
    ...
    \item Nous considérons le triangle $\triangle abc$ et nous plaçons un point $B'$ sur le segment $AB$, tel que $\angle{ACB'} \equiv \alpha'$.
     ...
     \begin{figure}[H]
    \centering
    \includegraphics[scale=0.9]{schema/Angle_externe_3.PNG}
\end{figure}
     \begin{flushright}
    $\bigstar $
    \end{flushright}
